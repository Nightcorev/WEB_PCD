...
@app.route("/upload_and_dilate", methods=["POST"])
@nocache
def upload_and_dilate():
    image_processing.dilate_image()
    return render_template("uploaded.html", file_path="img/img_now.jpg")
...
@nocache
def opening():
    image_processing.opening_image()
    return render_template("uploaded.html", file_path="img/img_now.jpg")

@app.route("/closing", methods=["POST"])
@nocache
def closing():
    image_processing.closing_image()
    return render_template("uploaded.html", file_path="img/img_now.jpg")

@app.route("/counting", methods=["POST"])
@nocache
def counting():
    jumlah_object=image_processing.counting_image()
    return render_template("uploaded.html", file_path="img/img_now.jpg",jumlah_object=jumlah_object)

@app.route("/fcc", methods=["POST"])
@nocache
def fcc():
    hasil_digit = image_processing.checkdigit()
    return render_template("uploaded.html", file_path="img/img_now.jpg", hasil_digit=hasil_digit)

@app.route("/emoji", methods=["POST"])
@nocache
def emoji():
    hasil_deteksi = image_processing.checkemoji()
    return render_template("uploaded.html", file_path="img/img_now.jpg", hasil_deteksi=hasil_deteksi)
